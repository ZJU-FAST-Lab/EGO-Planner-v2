...
struct MappingData
{
  ...
  std::list<Eigen::Vector3d> others_pos_;
...
private:
  ...
  void othersOdomCallback(const nav_msgs::OdometryConstPtr &odom);
  ...
  ros::Subscriber indep_cloud_sub_, indep_odom_sub_, extrinsic_sub_, others_odom_sub_;
